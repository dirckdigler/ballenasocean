...
<div id="node-<?php print $node->nid; ?>" class="product-teaser <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="overlay-add-cart">
        <a href="<?php print $node_url;?>"><i class="fa fa-shopping-cart"></i></a>
    </div>
